...
img_dir = 'realhand_data/test'  # raw image path
annotations_file = 'realhand_data/realhand-annotation-test.csv'  # pose annotation path
save_path = 'realhand_data/testK'  # path to store pose maps
