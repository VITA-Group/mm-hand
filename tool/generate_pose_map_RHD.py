...
img_dir = '/ssd1/wuzhenyu_sjtu/rhd_data/train'  # raw image path
annotations_file = '/ssd1/wuzhenyu_sjtu/rhd_data/rhd-annotation-train.csv'  # pose annotation path
save_path = '/ssd1/wuzhenyu_sjtu/rhd_data/trainK'  # path to store pose maps
