...
img_dir = 'ganerated_data/test'  # raw image path
annotations_file = 'ganerated_data/ganerated-annotation-test.csv'  # pose annotation path
save_path = 'ganerated_data/testK'  # path to store pose maps
